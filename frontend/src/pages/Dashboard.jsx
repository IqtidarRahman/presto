  ...
  return (
      <div id='background' style= {{ height: '100%', width: '100%', padding: '0', margin: '0', backgroundColour: 'red' }}>
        ...
        <Grid container spacing={0} style= {{ height: '100%' }}>
          ...
          <Grid item xs={12} style= {{ height: '85vh', backgroundColor: '#bfdbfe', display: 'flex', flexWrap: 'wrap', paddingTop: '1%', overflowY: 'auto' }}>
          ...
          <Grid item xs={12} style= {{ height: '3vh', backgroundColor: '#bfdbfe', fontFamily: 'Arial', color: '#f97316' }}>
